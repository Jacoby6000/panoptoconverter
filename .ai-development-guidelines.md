...
- Start with equirectangular; design APIs to add stereo modes later (OU/SBS) without breaking UI.
- Centralize projection math in `core/projection.ts`. Keep pure and testable.
